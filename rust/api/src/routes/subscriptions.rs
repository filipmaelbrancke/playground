...
// ResponseError = trait exposed by actix_web
// actix_web provides a default implementation for the `status_code()`
// as well as the `error_response()` methods that return a 500 Internal Server Error
